...
const texts = [
 ...
 setTimeout(() => {
  ...
  // Bấm vào ảnh → ẩn ảnh, hiện bài thơ
  img.addEventListener("click", () => {
    img.style.display = "none";
    // Di chuyển infoBox lên trên cùng
    const infoBox = document.getElementById("infoBox");
    if (infoBox) {
      const inner = infoBox.firstElementChild;
      ...
      inner.style.borderBottom = "2px solid hotpink";
      inner.style.borderRadius = "0 0 12px 12px";
    }
    ...
    // Click vào bài thơ → ẩn bài thơ, hiện lời chúc
    poem.addEventListener("click", () => {
      ...
      // Click vào lời chúc để thoát khỏi trang
      wish.addEventListener("click", () => {
        // Thử đóng tab (nếu được)
        window.close();

        // Nếu không được (trên thiết bị di động/chrome), chuyển hướng
        setTimeout(() => {
          window.location.href = "https://www.google.com"; // Hoặc bất kỳ link nào bạn muốn
        }, 300);
      });
    });
  });
